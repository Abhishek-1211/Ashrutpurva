        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 24),
              _themeOption(context, AppThemeType.obsidianGold, 'Obsidian Gold (Dark)'),
              _themeOption(context, AppThemeType.pureIvory, 'Pure Ivory (Light)'),
              _themeOption(context, AppThemeType.classicSepia, 'Classic Sepia (Warm)'),
              _themeOption(context, AppThemeType.slateMist, 'Slate Mist (Cool)'),
            ],
          ),
        );
      },
